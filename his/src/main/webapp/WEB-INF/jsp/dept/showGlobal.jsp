...
<head>
    ...
    <style type="text/css">
        ...
        .tree li button.ico_docu {
            background: url(zTreeStyle/img/folder_Close.gif);
        }

        .tree li a.curSelectedNode button.ico_docu {
            background: url(zTreeStyle/img/folder_Open.gif);
        }
    ...
    <script type="text/javascript">
        ...
        function reloadTree() {
            ...
            $.ajax({
                async: false,
                type: "GET",
                url: "dept/loadHosZtree.htm?time=" + new Date().getMilliseconds(),
                dataType: "json",
                error: function () {
                    alert("服务器内部错误！");
                },
