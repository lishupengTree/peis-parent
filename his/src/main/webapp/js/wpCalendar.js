...
function showCalendar() //主调函数
{
	...
	if(document.body.clientHeight>211 + thei && document.body.clientHeight-(ttop-document.body.scrollTop)<211+thei && ttop-document.body.scrollTop>211)	//added in Ver 2.1
		dads.top = ttop-211
	else if(thei && document.body.clientHeight-(ttop-document.body.scrollTop)<211+thei && ttop-document.body.scrollTop<211){ //下方不足，上方不足，显示中间
		dads.top = ttop - 95;  //2011-10-18 zzz 添加修改
...
var theme=new Object();
	...
	theme["NewAge"].normalDayColor		= "#f3f6f8";	//日期的背景颜色
